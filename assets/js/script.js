var particleAlphabet = {
    ...
    changeLetter: function() {
        var letters = 'HappyBirthdayErienaKartika♡',
    ...
    animate: function() {
        ...
        var myGradient = particleAlphabet.ctx.createLinearGradient(0, 0, 400, 1280);
        myGradient.addColorStop(0.1, "#F05F57");
        myGradient.addColorStop(1, "#360940");
        // particleAlphabet.ctx.fillStyle = 'rgba(23, 41, 58, .8)';
        particleAlphabet.ctx.fillStyle = myGradient;
